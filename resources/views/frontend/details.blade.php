...
@section('content')
    <section class="h-auto py-7 z-10 flex items-center w-full">
        <div class="xl:max-w-screen-xl 2xl:max-w-screen-2xl px-4 md:w-4/5 mx-auto">
            <div class="">
                <h1 class="text-lg font-semibold text-gray-800 mb-5">{{$articles->titre}}</h1>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 w-full">
                <div class="col-span-1 p-1 rounded-lg bg-gray-300 relative group transition-all duration-300">
                    ...
                    <div class="opacity-0 absolute bottom-2 w-11/12 left-[50%] translate-x-[-50%]  p-4 rounded-lg bg-black translate-y-4 bg-opacity-70 transition-all duration-300 group-hover:opacity-100 hover:translate-y-0">
                        <h1 class="text-lg font-bold text-gray-50">{{$articles->titre}}{{$articles->created_at}}</h1>
                    </div>
                </div>
                <div class="col-span-1  relative group transition-all duration-300">
                <p class="text-sm font-normal text-gray-700 text-justify">
                {{$articles->all_text}}
